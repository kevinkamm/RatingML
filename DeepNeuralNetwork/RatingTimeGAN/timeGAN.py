...
from DeepNeuralNetwork import RatingTimeGAN
import DeepNeuralNetwork.RatingTimeGAN.brownianMotion as bm
import DeepNeuralNetwork.RatingTimeGAN.loadRatingMatrices as lrm
